            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: recordState.ticketImagePath != null
                    ? DecorationImage(
                  image: recordState.ticketImagePath!.startsWith('http')
                      ? NetworkImage(recordState.ticketImagePath!) as ImageProvider
                      : FileImage(File(recordState.ticketImagePath!)) as ImageProvider,
                  fit: BoxFit.cover,
                )
                    : null,
              ),
